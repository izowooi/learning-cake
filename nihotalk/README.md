...
AI가 생성한 맞춤형 지문으로 읽기, 듣기, 단어, 문제, 쓰기까지 한 번에 학습할 수 있는 일본어 학습 웹앱입니다.

## ✨ 주요 기능

### 📖 읽기
- 원하는 주제와 난이도로 AI가 맞춤 일본어 지문 생성
- JLPT 5단계 난이도 (N5 ~ N1)
- 3단계 길이 (100~500 글자)
...
4. 이름 입력 (예: "nihotalk") 후 **Create secret key** 클릭
...
CLOUDFLARE_R2_BUCKET_NAME=nihotalk-audio
