...
const DIFFICULTY_OPTIONS: { value: DifficultyLevel; label: string; description: string }[] = [
  { value: 'n5', label: 'N5', description: 'JLPT N5 (초급)' },
  { value: 'n4', label: 'N4', description: 'JLPT N4 (초중급)' },
  { value: 'n3', label: 'N3', description: 'JLPT N3 (중급)' },
  { value: 'n2', label: 'N2', description: 'JLPT N2 (중상급)' },
  { value: 'n1', label: 'N1', description: 'JLPT N1 (상급)' },
]

const LENGTH_OPTIONS: { value: PassageLength; label: string; words: string }[] = [
  { value: 'short', label: '짧은 글', words: '100-200 글자' },
  { value: 'medium', label: '보통', words: '300-500 글자' },
  { value: 'long', label: '긴 글', words: '600-800 글자' },
]
...
export function PassageForm({ onGenerate, isLoading }: PassageFormProps) {
  const [difficulty, setDifficulty] = useState<DifficultyLevel>('n4')
