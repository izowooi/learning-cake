        ...
        <div className="p-6 overflow-y-auto max-h-[60vh]">
          {isLoading ? (
            ...
            <div className="space-y-4">
              ...
              {/* English Definition */}
              <div className="p-4 bg-slate-50 dark:bg-slate-900/50 rounded-xl">
                <h5 className="text-sm font-medium text-slate-500 dark:text-slate-400 mb-1">영영사전</h5>
                <p className="text-slate-700 dark:text-slate-300">{definition.englishDefinition}</p>
              </div>
